import index  from 'belt/menu/js/components/menu-items/index';
import create  from 'belt/menu/js/components/menu-items/create';
import edit  from 'belt/menu/js/components/menu-items/edit';
import params  from 'belt/menu/js/components/menu-items/edit/params';

// plugins
import pluginMenuItemDefault from 'belt/menu/js/components/menu-items/plugins/default';
import pluginMenuItemCategory from 'belt/menu/js/components/menu-items/plugins/category';
